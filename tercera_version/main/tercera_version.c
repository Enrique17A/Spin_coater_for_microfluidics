...
void motorRun(uint32_t porcentaje)
{
...
void app_main(void)
{
    ...
    while(1) {
        ...
        ESP_LOGI(TAG, "REF = %" PRIu32 " | ACTUAL = %" PRIu32 " | DUTY= %.1f%% | ACCION = %.2f", refPulsos, pulsos, dutyActual, accionControl);
    }
}
